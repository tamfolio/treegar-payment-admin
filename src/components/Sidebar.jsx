...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const bankingSubNavigation = [
    ...
    },
    {
      ...
      href: "/banking/scheduled-payments",
      icon: (
        <svg
          className="w-4 h-4"
          fill="none"
    ...
    {
      name: "P2P Transactions", // ← new
      href: "/banking/p2p-transactions",
      icon: (
        <svg
          className="w-4 h-4"
          fill="none"
